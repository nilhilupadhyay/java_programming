...
class Hotel{
    ...
    int id, noOfRoomsBooked;
    String name, dob, wifiF;
    double total;

    public Hotel(int id, String name, String dob, int noOfRoomsBooked, String wifiF, double total){
        this.id = id;
        this.name= name;
        this.dob= dob;
    ...
    public void setWifiF(String wifiF) {
        this.wifiF = wifiF;
    }
